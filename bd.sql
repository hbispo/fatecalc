...
insert  into `variaveis`(`idVariavel`,`idPagina`,`variavel`,`variavelTex`,`variavelLabel`,`descricao`,`resultado`,`monetario`,`casas`,`periodo`,`periodoPadrao`,`tipoValor`,`tipoValorPadrao`,`largura`,`ordem`) values 
(1,1,'D','D','D','Demanda ou consumo médio',0,0,2,1,'A',0,NULL,3,1),
(2,1,'cp','cp','cp','Custo de aquisição/ordem/pedido',0,1,2,0,NULL,0,NULL,3,2),
(3,1,'i','i','i','Taxa de juros ou custo de manutenção ou custo de armazenagem/estocagem',0,0,3,1,'A',1,'P',3,3),
(4,1,'v','v','v','Valor/custo unitário',0,1,2,0,NULL,0,NULL,3,4),
(5,1,'LEC','LEC','LEC','Lote Econômico de Compra',1,0,0,0,NULL,0,NULL,4,5),
(7,1,'FEP','FEP','FEP','Frequência de Pedidos (anual)',1,0,0,0,NULL,0,NULL,4,7),
(8,1,'TEP','TEP','TEP','Tempo Entre Pedidos (em dias)',1,0,0,0,NULL,0,NULL,4,8),
(9,1,'CTE','CTE','CTE','Custo Total Econômico',1,1,2,0,NULL,0,NULL,4,9),
(10,2,'Cp','C_p','Cp','Custo para preparar a produção para cada lote',0,1,2,0,NULL,0,NULL,4,1),
(11,2,'D','D','D','Demanda do item para o período considerado',0,0,0,1,'A',0,NULL,4,2),
(12,2,'Cf','C_f','Cf','Custo unitário de fabricação',0,1,2,0,NULL,0,NULL,4,3),
(13,2,'i','i','i','Taxa de juros do período',0,0,3,1,'A',1,'P',4,4),
(14,2,'u','u','u','Taxa de utilização por período (em dias)',0,0,0,1,'A',0,NULL,4,5),
(15,2,'p','p','p','Taxa de produção (por dia)',0,0,0,0,NULL,0,NULL,4,6),
(16,2,'LEF','LEF','LEF','Lote Econômico de Fabricação',1,0,0,0,NULL,0,NULL,4,7),
(17,2,'N','N','N','Número de lotes a serem fabricados',1,0,0,0,NULL,0,NULL,4,8),
(18,2,'Emedio','E_{médio}','E. médio','Estoque médio no período',1,0,0,0,NULL,0,NULL,4,9),
(19,2,'CS','CS','CS','Custo do sistema',1,1,2,0,NULL,0,NULL,4,10),
(20,3,'SVE','\\sum ve','Σ ve','Soma dos valores do estoque',0,1,2,0,NULL,0,NULL,3,1),
(21,3,'SQE','\\sum e','Σ e','Soma das quantidades do estoque',0,0,0,0,NULL,0,NULL,3,2),
(22,3,'T','T','T','Quantidade de períodos (Tempo)',0,0,0,0,NULL,0,NULL,3,3),
(23,3,'J','J','J','Juros',0,1,2,0,NULL,0,NULL,3,5),
(24,3,'CAL','CAL','CAL','Custo de aluguel',0,1,2,0,NULL,0,NULL,3,6),
(25,3,'SEG','SEG','SEG','Despesas com seguros',0,1,2,0,NULL,0,NULL,3,7),
(26,3,'PD','PD','PD','Perdas',0,1,2,0,NULL,0,NULL,3,8),
(27,3,'IMP','IMP','IMP','Despesas com impostos',0,1,2,0,NULL,0,NULL,3,9),
(28,3,'MOV','MOV','MOV','Custo com movimentação',0,1,2,0,NULL,0,NULL,3,10),
(29,3,'MO','MO','MO','Custo com mão de obra',0,1,2,0,NULL,0,NULL,3,11),
(30,3,'DES','DES','DES','Despesas em geral',0,1,2,0,NULL,0,NULL,3,12),
(31,3,'PMu','PMu','PMu','Preço Médio unitário',1,1,3,0,NULL,0,NULL,4,13),
(32,3,'EM','EM','EM','Estoque Médio',1,0,0,0,NULL,0,NULL,4,14),
(33,3,'CAu','CAu','CAu','Custo de Armazenagem unitário',1,1,4,0,NULL,0,NULL,4,15),
(34,3,'CA','CA','CA','Custo de Armazenagem',1,1,2,0,NULL,0,NULL,4,16),
(35,3,'VMEP','VMEP','VMEP','Valor Médio do Estoque no Período',0,1,2,0,NULL,0,NULL,3,4),
(36,4,'SSE','\\sum se','Σ se','Soma das saídas do estoque',0,0,0,0,NULL,0,NULL,3,1),
(37,4,'T','T','T','Quantidade de períodos (Tempo)',0,0,0,0,NULL,0,NULL,3,2),
(38,4,'d','d','d','Dias de estoque de segurança',0,0,0,0,NULL,0,NULL,3,3),
(39,4,'TR','TR','TR','Tempo de Reposição / prazo de entrega (em dias)',0,0,0,0,NULL,0,NULL,3,4),
(40,4,'CMM','CMM','CMM','Consumo Médio Mensal',1,0,0,0,NULL,0,NULL,4,5),
(41,4,'ES','ES','ES','Estoque de Segurança',1,0,0,0,NULL,0,NULL,4,6),
(42,4,'PP','PP','PP','Ponto de Pedido',1,0,0,0,NULL,0,NULL,4,7);
